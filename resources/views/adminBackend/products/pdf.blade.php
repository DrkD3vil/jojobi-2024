            ...
            <tbody>
                @foreach ($products as $index => $product)
                    <tr>
                        ...
                        <td>{{ $product->brand }}</td>
                        <td>
                            <img src="{{ $product->category_barcode_image_path }}"
                                alt="{{ $product->category_barcode }}" class="product-image">

                        </td>
                        <td>{{ $product->product_type }}</td>
                        <td>
                            <img src="{{ $product->barcode_image_path }}" alt="{{ $product->product_barcode }}"
                                class="product-image">
                        </td>
                    </tr>
                @endforeach
