        ...
        <tbody>
            ...
            @forelse(session('cart', []) as $id => $item)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('transactions.remove', $id) }}">Remove</a>
                    </td>
                </tr>
            @empty
                <tr>
        ...
        <tfoot>
            ...
            <tr>
                <td colspan="7" style="text-align: right;">
                    <a href="{{ route('transactions.clear') }}">Clear Cart</a>
                    <form action="{{ route('transactions.checkout') }}" method="POST" style="display:inline;">
                        @csrf
