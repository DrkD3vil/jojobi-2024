...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('adminFiles/assets/img/favicon/favicon.ico') }}" />
    ...
    <!-- Remixicon -->
    <link rel="stylesheet" href="{{ asset('adminFiles/assets/vendor/fonts/remixicon/remixicon.css') }}" />

    <!-- Node Waves -->
    <link rel="stylesheet" href="{{ asset('adminFiles/assets/vendor/libs/node-waves/node-waves.css') }}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('adminFiles/assets/vendor/css/core.css') }}"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('adminFiles/assets/vendor/css/theme-default.css') }}"
        class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('adminFiles/assets/css/demo.css') }}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet"
        href="{{ asset('adminFiles/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/assets/vendor/libs/apex-charts/apex-charts.css') }}" />

    <!-- Page CSS -->

    <!-- Helpers -->
    <script src="{{ asset('adminFiles/assets/vendor/js/helpers.js') }}"></script>

    <!-- Template Customizer & Theme Config -->
    <script src="{{ asset('adminFiles/assets/js/config.js') }}"></script>
</head>
...
<body>
    ...
    <script src="{{ asset('adminFiles/assets/vendor/libs/jquery/jquery.js') }}"></script>
    <script src="{{ asset('adminFiles/assets/vendor/libs/popper/popper.js') }}"></script>
    <script src="{{ asset('adminFiles/assets/vendor/js/bootstrap.js') }}"></script>
    <script src="{{ asset('adminFiles/assets/vendor/libs/node-waves/node-waves.js') }}"></script>
    <script src="{{ asset('adminFiles/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
    <script src="{{ asset('adminFiles/assets/vendor/js/menu.js') }}"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{ asset('adminFiles/assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>
