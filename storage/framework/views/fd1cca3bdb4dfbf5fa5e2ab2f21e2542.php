...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function fetchDataAndUpdateChart() {
            $.ajax({
                url: "<?php echo e(route('sales.getCategorySalesData')); ?>", // Backend route for data
                method: "GET",
                ...
                <div class="col-6">
                    <div class="card-body">
                        <div class="card-info">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <h4 class="mb-0 me-2">BDT<?php echo e(number_format($lastWeekProfit, 2)); ?></h4>

                                <!-- Display percentage change -->
                                <?php if($weekPercentageChange >= 0): ?>
                                <p class="text-success mb-0">+<?php echo e(number_format($weekPercentageChange, 2)); ?>%</p>
                                <?php else: ?>
                                <p class="text-danger mb-0"><?php echo e(number_format($weekPercentageChange, 2)); ?>%</p>
                                <?php endif; ?>
                            </div>
                            <div class="badge bg-label-secondary rounded-pill mb-xl-1">
                                <?php echo e($startOfLastWeek->format('d F Y')); ?> - <?php echo e($endOfLastWeek->format('d F Y')); ?>
