...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Cart Table -->
    <h2>Edit Order #<?php echo e($order->order_number); ?></h2>
    <form id="cartForm" action="<?php echo e(route('orders.update', $order->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <table border="1">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = session('cart', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo e(asset('baackend_images/' . $item['image'])); ?>" alt="Product Image" width="50">
                        </td>
                        <td><?php echo e($item['name']); ?></td>
                        <td>
                            <input type="number" name="cart[<?php echo e($id); ?>][quantity]" class="quantity-input"
                                value="<?php echo e($item['quantity']); ?>" min="1" style="width: 60px;">
                        </td>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td id="total_price">$<?php echo e(number_format($subtotal_price, 2)); ?></td>
                    <td></td>
                </tr>
            </tfoot>
        </table>
    ...
    <script>
        ...
        function updateCart() {
            ...
            $.ajax({
                url: "<?php echo e(route('orders.update', $order->id)); ?>", // Ensure this points to the correct route
                method: "POST",
                data: cartData,
                headers: {
        ...
        function addProductToCart() {
            ...
            $.ajax({
                url: "<?php echo e(route('orders.addProduct', $order->id)); ?>", // Route for adding a product
                method: "POST",
                data: {
                    barcode: barcode,
...
<?php echo $__env->make('adminBackend.adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Bijoy Dey\Laravel\jojobi\resources\views/adminBackend/orders/edit.blade.php ENDPATH**/ ?>