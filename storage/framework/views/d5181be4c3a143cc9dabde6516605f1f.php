<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('orders.store')); ?>" method="POST" class="form-container">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="cart_id" id="cart_id" class="form-control" value="<?php echo e($cart->cart_id); ?>"
                    readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="subtotal" id="subtotal" class="form-control"
                    value="<?php echo e($cart->subtotal_price); ?>" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="round_total" id="round_total" class="form-control"
                    value="<?php echo e(round($cart->subtotal_price, 2)); ?>" readonly>
            </div>
        ...
        <div class="action mt-4" style="text-align: center;">
            <a href="<?php echo e(route('carts.edit', $cart->cart_id)); ?>" class="btn btn-warning btn-block">Add More Product</a>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        $('#create-customer-form-element').on('submit', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('customers.store')); ?>", // Adjust this to your actual route name
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
...
<?php echo $__env->make('adminBackend.adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bijoydey/Desktop/jojobi/resources/views/adminBackend/orders/create.blade.php ENDPATH**/ ?>