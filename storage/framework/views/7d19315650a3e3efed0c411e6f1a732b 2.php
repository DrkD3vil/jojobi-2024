...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline py-4 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="<?php echo e(route('password.request')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-full py-4 justify-center text-lg font-medium text-black bg-gray-300 hover:bg-yellow-400 border border-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full py-4 justify-center text-lg font-medium text-black bg-gray-300 hover:bg-yellow-400 border border-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500']); ?>
            <span class="text-black"><?php echo e(__('Log in')); ?></span>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <!-- Google login -->
        <div class="text-center mt-5">
            <a href="<?php echo e(route('auth.google')); ?>" class=" w-full inline-flex items-center justify-center bg-white text-black border border-black rounded-md px-5 py-3 text-lg font-medium hover:bg-gray-200">
...
<?php endif; ?>
<?php /**PATH /Users/bijoydey/Desktop/jojobi/resources/views/auth/login.blade.php ENDPATH**/ ?>