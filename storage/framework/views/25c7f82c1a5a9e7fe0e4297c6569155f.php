<div class="row gy-6">
    ...
    <div class="col-md-12 col-lg-4">
        <div class="card">
            ...
            <img src="<?php echo e(asset('adminFiles/assets/img/illustrations/trophy.png')); ?>"
                ...
                <ul class="p-0 m-0">
                    <li class="d-flex mb-6">
                        <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                            <img src="<?php echo e(asset('adminFiles/assets/img/icons/misc/zipcar.png')); ?>" alt="zipcar" />
                        </div>
                        <div
                    ...
                    <li class="d-flex mb-6">
                        <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                            <img src="<?php echo e(asset('adminFiles/assets/img/icons/misc/bitbank.png')); ?>" alt="bitbank" />
                        </div>
                        <div
                            class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex">
                        <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                            <img src="<?php echo e(asset('adminFiles/assets/img/icons/misc/aviato.png')); ?>" alt="aviato" />
                        </div>
                        <div
                            class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/payments/gumroad.png')); ?>"
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/payments/mastercard-2.png')); ?>"
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/payments/stripes.png')); ?>"
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/payments/american-bank.png')); ?>"
                            ...
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/payments/citi.png')); ?>"
                ...
                <div class="card-body">
                    ...
                    <div class="withdraw-content pt-2">
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/brands/google.png')); ?>"
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/brands/github.png')); ?>"
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/brands/slack.png')); ?>"
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/payments/digital-ocean.png')); ?>"
                            ...
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-4">
                                    <img src="<?php echo e(asset('adminFiles/assets/img/icons/brands/aws.png')); ?>"
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/1.png')); ?>" alt="Avatar"
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/3.png')); ?>"
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/2.png')); ?>"
                                            alt="Avatar" class="rounded-circle" />
                                    </div>
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/5.png')); ?>"
                                            alt="Avatar" class="rounded-circle" />
                                    </div>
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/4.png')); ?>"
                                            alt="Avatar" class="rounded-circle" />
                                    </div>
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/7.png')); ?>"
                                            alt="Avatar" class="rounded-circle" />
                                    </div>
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/6.png')); ?>"
                                            alt="Avatar" class="rounded-circle" />
                                    </div>
                                    <div>
                        ...
                        <tr class="border-transparent">
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-4">
                                        <img src="<?php echo e(asset('adminFiles/assets/img/avatars/1.png')); ?>"
                                            alt="Avatar" class="rounded-circle" />
                                    </div>
                                    <div>
    ...
    <!--/ Data Tables -->
</div><?php /**PATH /Users/bijoydey/Desktop/jojobi/resources/views/adminBackend/content.blade.php ENDPATH**/ ?>