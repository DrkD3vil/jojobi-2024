...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="cart[<?php echo e($id); ?>][quantity]" class="quantity-input"
                                data-id="<?php echo e($id); ?>" value="<?php echo e($item['quantity']); ?>" min="1"
                                style="width: 60px;">
                        </td>
                        <td><?php echo e($item['category']); ?></td>
                        <td>$<?php echo e(number_format($item['price'], 2)); ?></td>
                        <td>
                            <a href="<?php echo e(route('pos.remove', $id)); ?>">Remove</a>
                        </td>
                    </tr>
    ...
    <form action="<?php echo e(route('pos.checkout')); ?>" method="POST" style="text-align:right;">
        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function updateCart() {
            ...
            $.ajax({
                url: "<?php echo e(route('pos.updateCart')); ?>",
                method: "POST",
                data: cartData,
